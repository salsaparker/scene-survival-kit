module PlaylistsHelper
  ...
  def embed_player_url(url)
    ...
    if player_match = url.to_s.match(/youtube.com.*(?:\/|v=)([^&$]+)/)
      yt_uid = player_match[1]
      yt_url = 'https://www.youtube.com/embed/' + yt_uid
    end
    if player_match = url.to_s.match(/soundcloud.com.*(?:\/|v=)/)
      sc_playlist = url
...
# <iframe id="sc-widget" src="<%= embed%>" width="100%" height="465" scrolling="no" frameborder="no"></iframe>
